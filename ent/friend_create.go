...
func (fc *FriendCreate) SetUsername(s string) *FriendCreate {
	fc.mutation.SetUsername(s)
	return fc
}

// SetFriend sets the "friend" field.
func (fc *FriendCreate) SetFriend(s string) *FriendCreate {
	fc.mutation.SetFriend(s)
	return fc
}
...
func (fc *FriendCreate) check() error {
	if _, ok := fc.mutation.Username(); !ok {
		return &ValidationError{Name: "username", err: errors.New(`ent: missing required field "Friend.username"`)}
	}
	if _, ok := fc.mutation.Friend(); !ok {
		return &ValidationError{Name: "friend", err: errors.New(`ent: missing required field "Friend.friend"`)}
	}
	if _, ok := fc.mutation.CreatedAt(); !ok {
...
func (fc *FriendCreate) createSpec() (*Friend, *sqlgraph.CreateSpec) {
	...
	if value, ok := fc.mutation.Friend(); ok {
